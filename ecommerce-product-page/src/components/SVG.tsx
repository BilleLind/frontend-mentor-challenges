...
export const IconDelete = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="14" height="16" xmlns="http://www.w3.org/2000/svg" /* xmlns:xlink="http://www.w3.org/1999/xlink" */ {...props}>
			<defs>
				<path
...
export const IconMenu = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="16" height="16"  {...props} /* xmlns="http://www.w3.org/2000/svg" */>
...
export const IconMinus = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="12" height="4" xmlns="http://www.w3.org/2000/svg" /* xmlns:xlink="http://www.w3.org/1999/xlink" */ {...props}>
			<defs>
...
export const IconPlus = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" /* xmlns:xlink="http://www.w3.org/1999/xlink" */ {...props}>
			<defs>
				<path
