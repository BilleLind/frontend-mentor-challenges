	...
	return (
		<div>
			<svg width="14" height="15" xmlns="http://www.w3.org/2000/svg" {...props}>
				<path d="m11.596.782 2.122 2.122L9.12 7.499l4.597 4.597-2.122 2.122L7 9.62l-4.595 4.597-2.122-2.122L4.878 7.5.282 2.904 2.404.782l4.595 4.596L11.596.782Z" fill="current" fill-rule="evenodd" />
			</svg>
		</div>
	)
}
export const IconDelete = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="14" height="16" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...props}>
			<defs>
				<path
			...
			<use fill="#C3CAD9" fill-rule="nonzero" xlinkHref="#c" />
		</svg>
	)
}
...
export const IconMinus = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="12" height="6" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...props}>
			<defs>
			...
			<use fill="current" fill-rule="nonzero" xlinkHref="#a" /> {/* #FF7E1B */}
		</svg>
	)
}
...
export const IconPlus = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...props}>
			<defs>
				<path
			...
			<use fill="current" fill-rule="nonzero" xlinkHref="#b" /> {/* #FF7E1B */}
		</svg>
	)
}
